...
import { FirebaseError as r, getGlobal as i, isIndexedDBAvailable as s, getUA as o, base64 as _, DecodeBase64StringError as a, isSafariOrWebkit as u, isSafari as c, isCloudWorkstation as l, pingServer as h, deepEqual as P, createMockUserToken as T, getModularInstance as I, getDefaultEmulatorHostnameAndPort as E } from "@firebase/util";

import { Integer as R, Md5 as A } from "@firebase/webchannel-wrapper/bloom-blob";

import { Logger as V, LogLevel as d } from "@firebase/logger";

import { getStatEventTarget as m, Event as f, XhrIo as g, EventType as p, ErrorCode as y, WebChannel as w, createWebChannelTransport as b, Stat as S } from "@firebase/webchannel-wrapper/webchannel-blob";
 ...
 * limitations under the License.
 */
const C = new V("@firebase/firestore");
...
function __PRIVATE__fail(e, t, n) {
    ...
    let r = `FIRESTORE (${D}) INTERNAL ASSERTION FAILED: ${t} (ID: ${e.toString(16)})`;
    if (void 0 !== n) try {
 ...
 */ function __PRIVATE_validateJSON(e, t) {
    if (!__PRIVATE_isPlainObject(e)) throw new FirestoreError(v.INVALID_ARGUMENT, "JSON must be an object");
    let n;
    ...
    if (n) throw new FirestoreError(v.INVALID_ARGUMENT, n);
    return !0;
}
...
class Timestamp {
    ...
    t) {
        ...
        if (e < N) throw new FirestoreError(v.INVALID_ARGUMENT, "Timestamp seconds out of range: " + e);
 ...
 */ async function __PRIVATE_ignoreIfPrimaryLeaseLoss(e) {
    if (e.code !== v.FAILED_PRECONDITION || e.message !== k) throw e;
...
/** Implements the steps for backfilling indexes. */ class __PRIVATE_IndexBackfiller {
     ...
     */    oe(e, t, n) {
        ...
        return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e, t).next((r => this.localStore.localDocuments.getNextDocuments(e, t, r, n).next((n => {
            const i = n.changes;
            return this.localStore.indexManager.updateIndexEntries(e, i).next((() => this._e(r, n))).next((n => (__PRIVATE_logDebug(U, `Updating offset: ${n}`), 
...
/** Converts a Base64 encoded string to a binary string. */ function __PRIVATE_decodeBase64(e) {
    try {
        ...
        _.decodeStringToByteArray(e, tt));
    } catch (e) {
 ...
 *   localWriteTime.
 */ const rt = "server_timestamp", it = "__type__", st = "__previous_value__", ot = "__local_write_time__";

function __PRIVATE_isServerTimestamp(e) {
    const t = (e?.mapValue?.fields || {})[it]?.stringValue;
    return t === rt;
}
...
/** The default database name for a project. */ const _t = "(default)";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const at = "__type__", ut = "__max__", ct = {
    mapValue: {
        fields: {
            __type__: {
                stringValue: ut
    ...
    switch (n) {
      ...
      case 10 /* TypeOrder.VectorValue */ :
        return function __PRIVATE_compareVectors(e, t) {
            const n = e.fields || {}, r = t.fields || {}, i = n[ht]?.arrayValue, s = r[ht]?.arrayValue, o = __PRIVATE_primitiveComparator(i?.values?.length || 0, s?.values?.length || 0);
            if (0 !== o) return o;
      ...
      case 11 /* TypeOrder.ObjectValue */ :
        return function __PRIVATE_compareMaps(e, t) {
            if (e === ct.mapValue && t === ct.mapValue) return 0;
            if (e === ct.mapValue) return 1;
            if (t === ct.mapValue) return -1;
...
const At = new SortedSet(DocumentKey.comparator);
...
const Vt = new SortedSet(__PRIVATE_primitiveComparator);
