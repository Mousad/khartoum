...
const categories = [
  ...
  },
  {
    key: 'shoes',
    name: 'أحذية',
    img: 'https://i.pinimg.com/736x/43/ce/9b/43ce9bc4748a49738144db6957ee1fd8.jpg',
  },
  {
    key: 'accessories',
    name: 'إكسسوارات',
    ...
    <div className="min-h-screen">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-center justify-end">
                <div className="p-6 md:p-10 text-white text-right max-w-lg">
                  ...
                  <h2 className="text-4xl font-bold mb-4">
                    اكتشف عالم التسوق مع <span className="text-[#f8c538]">Khartoum</span> Lights
                  </h2>
      ...
      <section className="bg-[#2a2e30] overflow-hidden mb-6">
        <div className="whitespace-nowrap animate-marquee py-3">
          ...
          <span className="mx-8 text-white font-semibold">🛍️ براندات مميزة</span>
          <span className="mx-8 text-white font-semibold">💳 الدفع عند الاستلام</span>
        </div>
      </section>
      ...
      <section className="px-4 mb-8">
        <div className="flex justify-between mb-4">
          ...
          <Link to="/shop" className="text-[#5433eb] text-sm">Shop All</Link>
        </div>
  ...
  <h2 className="text-[#183153]">Featured Brands</h2>
        ...
        <div className="flex gap-4 overflow-x-auto">
          {featuredBrands.map((brand) => (
            <Link key={brand.id} to={`/brands/${brand.id}`} className="w-40 bg-white rounded-2xl shadow-sm">
              <img src={brand.cover} className="h-24 w-full object-cover" />
              <div className="p-3 text-center">
                <img src={brand.logo} className="w-12 h-12 rounded-full mx-auto -mt-6 border-2 border-white" />
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 items-center bg-white rounded-2xl overflow-hidden shadow-sm">
    ...
    <div className="p-6 md:p-10 text-right">
      ...
      <p className="text-[#183153] opacity-70 mb-6 leading-relaxed">
        شاهد فيديو تعريفي عن البراندات والمنتجات، واستمتع بتجربة تسوق حديثة وسهلة من مكان واحد.
      </p>
...
<section className="px-4 my-10">
  ...
  <div className="flex items-center justify-between mb-4">
    ...
    <button className="text-[#5433eb] text-sm">
      عرض الكل
    </button>
  </div>
